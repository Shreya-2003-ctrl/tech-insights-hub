...
export function BlogCard({ post, onClick }: BlogCardProps) {
  return (
    <article
      className="group bg-card rounded-lg overflow-hidden card-shadow hover:card-shadow-hover transition-all duration-300 cursor-pointer focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
      onClick={onClick}
      onKeyDown={(e) => {
